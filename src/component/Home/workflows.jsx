  ...
  return (
    <section className="bg-black-dark text-white-light relative">
      <div className=" container mx-auto px-4 py-20 lg:pb-32 relative z-10">
        <h2 className="text-[54px] leading-tight font-normal text-section-title text-center mb-6 text-white">
          Your Workflows,
              ...
              <div
                ...
                <div className="flex flex-col">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <p className="text-base text-blue flex items-center gap-2">
                      <svg
                        width="16"
                        height="16"
                        viewBox="0 0 16 16"
